    ...
    >
        <div class="modal-content">
            ...
            <form ref="form" @submit="submitForm($event)">
                ...
                <h1>Zapisy na kurs Katechezy Systemowej</h1>
                <p>Numer Kursu: <span>{{ courseId }}</span></p>
                <div class="inputs-container">
                    ...
                    <select required v-model="education">
                        <option selected disabled value="">Wykształcenie*</option>
                        <option value="mgr. teologii">mgr. teologii</option>
                        <option value="mgr.li. teologii">mgr.li. teologii</option>
                        <option value="dr. teologii">dr. teologii</option>
                    </select>
                    <textarea placeholder="Uwagi" v-model="info"></textarea>
                    <div class="rodo">
                        <input type="checkbox" required id="rodo" v-model="rodo">
                        Przeczytałem i akceptuję<a href="../../../../public/rodo.pdf" target="_blank">Politykę prywatności.*</a>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            submitForm(e) {
                e.preventDefault();
                this.loading = true;
                this.coursesService.enrollUser(
                    this.courseId,
                    this.firstName,
                    this.lastName,
                    this.email,
